    ...
    <>
      <div className="py-10 flex place-content-center">
        <div
          ...
          data-active-classes="bg-white dark:bg-gray-900"
          className="border-2 rounded-3xl p-8 w-[580px]"
        >
          <h2 id="accordion-flush-heading-1">
            <button
              type="button"
              class="flex items-center justify-between w-full py-5 rtl:text-right border-b border-gray-200 dark:border-gray-700 gap-3"
