...
export function Questions() {
  return (
    <>
      <div className="py-10 flex place-content-center">
        ...
        >
          <h2 id="accordion-flush-heading-1">
            <button
              type="button"
              class="flex items-center justify-between w-full py-5 rtl:text-right border-b border-gray-200 gap-3"
            ...
            >
              ...
              <svg
                data-accordion-icon
                class="w-3 h-3 rotate-180 shrink-0 text-black dark:text-white"
                aria-hidden="true"
          ...
          >
            <div class="py-5 border-b border-gray-200 dark:border-white">
              <p class="mb-2 text-[#7B7583]">
          ...
          <h2 id="accordion-flush-heading-2">
            <button
              type="button"
              class="flex items-center justify-between w-full py-5 rtl:text-right border-b border-gray-200 dark:border-white gap-3"
          ...
          <h2 id="accordion-flush-heading-6">
            <button
              type="button"
              class="flex items-center justify-between w-full py-5 rtl:text-right gap-3"
      ...
      <div className="flex place-content-center py-12">
